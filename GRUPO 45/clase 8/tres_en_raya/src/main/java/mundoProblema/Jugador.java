...
public abstract class Jugador {
        ...
        //Elegir la casilla del tablero aleatoriamente para realizar la jugada.
        ...
        public Casilla elegirCasillaAleatoria(Tablero tablero){
            ...
            // Solicitarle al tablero las casillas que están libres
            ArrayList<Casilla>casillasLibres = tablero.obtenerCasillasVacias();
    
            // Selección casilla aleatoria math.random
            ...
            // Retornar las casilla seleccionada
        ...
        // Ejecutar estrategia Aleatoria, los parámetros es lo que necesita, en esta caso necesita el tablero.
    
        public void ejecutarEstrategiaAleatoria(Tablero tablero){
    
            // Selecciona la casilla libre aleatoriamente y efectua ese movimiento
